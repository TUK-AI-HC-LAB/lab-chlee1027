...
본 제안은 직접 재현한 4개 알고리즘(M1~M4)의 공학적 분석을 기반으로 도출된 후속 연구 방향임. 제안된 3가지 주제(A, B, C) 중 연구실의 차기 목표로서 가장 학술적 가치와 투고 가능성이 높다고 판단되는 방향에 대해 교수님의 검토 및 지도를 요청함. 선정된 방향에 맞춰 세부 아키텍처 설계 및 MVTec LOCO AD 기반 실험 설계를 진행하고자 함.
