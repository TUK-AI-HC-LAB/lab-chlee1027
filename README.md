...
| 3 | [method3_RD](method3_RD/source/) | Deng et al., 2022, Anomaly Detection via Reverse Distillation from One-Class Embedding (CVPR 2022, RD) | 재현 진행 중 (MVTec AD: 12/15 카테고리) |
...
- **2026-W21 (5/21 미팅 예정)** — PatchCore 프로젝트 최종 문서화 및 환경 재현성 확보 계획 검토. **SimpleNet 전 카테고리(15/15) 재현 완료. 논문 동일 환경 설정 반영.** method3 Reverse Distillation 착수. → [meetings/2026-W21_brief.md](meetings/2026-W21_brief.md)
