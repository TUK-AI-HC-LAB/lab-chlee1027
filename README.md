...
- **2026-W22 (5/28 미팅)** — **Reverse Distillation 전 카테고리(15/15) 완결 및 분석 보고.** (5/22 완료) **method4 Dinomaly 전 카테고리(15/15) 재현 완료 및 수치 검증(Mean I-AUROC 0.9962).** SimpleNet 구조적 약점 분석(screw/capsule) 및 4-way 비교 프레임워크 설계 완료. → [meetings/2026-W22_brief.md](meetings/2026-W22_brief.md)
- **2026-W23 (6/4 미팅 예정)** — **PatchCore 파이프라인 컴포넌트별 프로파일링 및 FAISS 고속 인덱스 비교 분석.** 단계별 latency/memory 측정 및 exact search 대비 IVF/HNSW/PQ index 기법 성능-속도-메모리 trade-off 벤치마크 수행. → [meetings/2026-W23_brief.md](meetings/2026-W23_brief.md)
