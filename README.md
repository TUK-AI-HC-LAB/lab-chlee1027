...
| 3 | [method3_RD](method3_RD/source/) | Deng et al., 2022, Anomaly Detection via Reverse Distillation from One-Class Embedding (CVPR 2022, RD) | 재현 진행 중 (MVTec AD: 1/15 카테고리) |
