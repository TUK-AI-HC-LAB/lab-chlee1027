...
| 2 | [method2_simplenet](method2_simplenet/source/) | Liu et al., 2023, *SimpleNet: A Simple Network for Image Anomaly Detection and Localization* (CVPR 2023) | **재현 2/15 진행 중 (toothbrush·bottle, 모두 I-AUROC 1.000 / P-AUROC 0.985·0.978) — 시각화 패치 완료** |
...
- **2026-W21 (5/21 미팅 예정)** — PatchCore 프로젝트 최종 문서화 및 환경 재현성 확보 계획 검토. **SimpleNet 1·2차 재현 (toothbrush·bottle, 2/15) + 시각화 버그 수정 완료, method3 Reverse Distillation 착수.** → [meetings/2026-W21_brief.md](meetings/2026-W21_brief.md)
