...
| 2 | [method2_simplenet](method2_simplenet/source/) | Liu et al., 2023, *SimpleNet: A Simple Network for Image Anomaly Detection and Localization* (CVPR 2023) | **재현 9/15 진행 중 (toothbrush·bottle·metal_nut·wood·pill·transistor·cable·hazelnut·leather) — 논문 파라미터 적용** |
