...
| 2 | [method2_simplenet](method2_simplenet/source/) | Liu et al., 2023, *SimpleNet: A Simple Network for Image Anomaly Detection and Localization* (CVPR 2023) | **재현 7/15 진행 중 (toothbrush·bottle·metal_nut·wood·pill·transistor·cable) — 논문 파라미터 적용** |
...
- **2026-W21 (5/21 미팅 예정)** — PatchCore 프로젝트 최종 문서화 및 환경 재현성 확보 계획 검토. **SimpleNet 1~7차 재현 (7/15) 완료. 논문 동일 환경 설정 반영.** method3 Reverse Distillation 착수. → [meetings/2026-W21_brief.md](meetings/2026-W21_brief.md)
