...
| 3 | [method3_RD](method3_RD/source/) | Deng et al., 2022, Anomaly Detection via Reverse Distillation from One-Class Embedding (CVPR 2022, RD) | 재현 진행 중 (MVTec AD: 14/15 카테고리) |
...
- **2026-W21 (5/21 미팅 예정)** — **SimpleNet 전 카테고리(15/15) 재현 완료** + PatchCore 최종 문서화. **method3 Reverse Distillation 착수 → 13/15 재현 진행**, 3-way 비교 분석 작성. → [meetings/2026-W21_brief.md](meetings/2026-W21_brief.md)
