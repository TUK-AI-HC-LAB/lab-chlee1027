...
| :--- | :---: | :---: | :---: |
| **I-AUROC** | **0.9962** | 0.996 | ✅ Success |
| **P-AUROC** | **0.9832** | 0.984 | ✅ Success |
...
> 1차 탐색 및 재현은 김준아 학생의 fork 기반 패치 로직을 적용한 통합 노트북(`dinomaly_colab.ipynb`)으로 완결.
...
- commit: `6f8e1c0`
- sh / 노트북: `method4_Dinomaly/source/run_baseline.sh` / `dinomaly_colab.ipynb`
- csv: `method4_Dinomaly/source/results/baseline_*.csv`
