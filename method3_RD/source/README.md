...
MVTec AD **14/15 카테고리** 재현 완료 (hazelnut 진행 중).

| Metric | Repro (Mean, 14개) | Status |
| :--- | :---: | :---: |
| **I-AUROC** | **0.987** | 🔄 14/15 |
| **Full P-AUROC** | **0.978** | 🔄 14/15 |
